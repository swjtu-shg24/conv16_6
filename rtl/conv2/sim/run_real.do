#=============================================================================
# rtl/conv2/sim/run_real.do -- 真实激励端到端（test.jpg + 真实权重 ROM）
#   在**工程根目录**执行：  vsim -c -do rtl/conv2/sim/run_real.do
#
...
vsim -c -voptargs=+acc -l rtl/conv2/sim/transcript_real -wlf rtl/conv2/sim/real.wlf c2all.tb_top_real
run -all
quit -f

#=============================================================================
# rtl/conv2/sim/run.do —— 顶层（本层）仿真脚本
#   在**工程根目录**执行：  vsim -c -do rtl/conv2/sim/run.do
#
...
vsim -c -voptargs=+acc -l rtl/conv2/sim/transcript -wlf rtl/conv2/sim/top.wlf c2all.tb_top
run -all
quit -f

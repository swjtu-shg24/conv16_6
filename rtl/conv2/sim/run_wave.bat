@echo off
REM ==========================================================================
REM  rtl\conv2\sim\run_wave.bat -- GLOBAL simulation with waveforms (GUI)
REM
...
REM
REM  Waves are grouped in DATA-FLOW order by rtl\conv2\sim\wave_full.do:
...
REM
REM  Artifacts: rtl\conv2\sim\wave.wlf (waves), rtl\conv2\sim\transcript_wave (text log)
...
echo   waves: rtl\conv2\sim\wave.wlf    log: rtl\conv2\sim\transcript_wave
%VSIM% -gui -voptargs=+acc -l rtl/conv2/sim/transcript_wave -wlf rtl/conv2/sim/wave.wlf -do rtl/conv2/sim/wave_full.do %TB%

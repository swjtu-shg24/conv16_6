@echo off
REM ==========================================================================
REM  rtl\conv2\conv_win_load_plane\run.bat -- self-check for this folder only
REM    Double-click it, or from the project root:
REM        vsim -c -do rtl/conv2/conv_win_load_plane/run.do
REM    work\ transcript\ *.wlf all stay inside this folder.
REM    Verdict = the  "TB_WIN_PLANE RESULT: PASS/FAIL"  line at the end.
REM ==========================================================================
cd /d %~dp0..\..\..

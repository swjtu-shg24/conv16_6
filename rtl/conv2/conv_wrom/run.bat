@echo off
REM ==========================================================================
REM  rtl\conv2\conv_wrom\run.bat -- self-check for this module folder only
REM    Double-click it, or from the project root:
REM        vsim -c -do rtl/conv2/conv_wrom/run.do
REM    Verdict = the "TB_WROM RESULT: PASS/FAIL" line at the end of transcript.
REM ==========================================================================
cd /d %~dp0..\..\..
...
%VSIM% -c -do rtl/conv2/conv_wrom/run.do
pause

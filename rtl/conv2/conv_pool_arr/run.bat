@echo off
REM ==========================================================================
REM  rtl\conv2\conv_pool_arr\run.bat -- self-check for this module folder only
REM    Double-click it, or from the project root:
REM        vsim -c -do rtl/conv2/conv_pool_arr/run.do
...
%VSIM% -c -do rtl/conv2/conv_pool_arr/run.do
pause